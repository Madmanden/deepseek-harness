...
- `PEAK` / `OFF-PEAK` based on `Europe/Copenhagen`
...
1. Set the four `PRICING` values to the provider's USD price per 1M tokens.
2. Change `PEAK_WINDOWS` if peak hours are different.
